CREATE DATABASE ТМРKarle_UNIVER
on primary
...
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )	values  ('БФ',		'Белорусской филологии',															'ИДиП')
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )	values  ('РИТ',		'Редакционно-издательских тенологий',												'ИДиП')            
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )	values  ('ПП',		'Полиграфических производств',														'ИДиП')                              
...
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )	values  ('МиАХиСП',	'Машин и аппаратов химических и силикатных производств',							'ХТиТ')               
...
insert into  TEACHER    (TEACHER, TEACHER_NAME, GENDER, PULPIT )	values  ('РВКЧ',	'Ровкач Андрей Иванович',				'м',	'ОВ');
...
insert into  TEACHER    (TEACHER, TEACHER_NAME, GENDER, PULPIT )	values  ('МШКВСК',  'Машковский Владимир Петрович',			'м',	'ЛУ');
insert into  TEACHER    (TEACHER, TEACHER_NAME, GENDER, PULPIT )	values  ('АТР',     'Атрощенко Олег Александрович',			'м',	'ЛУ');                       
...
insert into  TEACHER    (TEACHER, TEACHER_NAME, GENDER, PULPIT )	values  ('МХВ',		'Мохов Сергей Петрович',				'м',	'ЛМиЛЗ'); 
insert into  TEACHER    (TEACHER, TEACHER_NAME, GENDER, PULPIT )	values  ('ЕЩНК',	'Ещенко Людмила Семеновна',				'ж',	'ТНВиОХТ');                       
...
insert into PROGRESS (SUBJECT,IDSTUDENT,PDATE, NOTE)
    values ('ОХ',		1064,  '01.01.2013',	6),
           ('ОХ',		1065,  '01.01.2013',	4),
           ('ОХ',		1066,  '01.01.2013',	9),
           ('ОХ',		1067,  '01.01.2013',	5),
           ('ОХ',		1068,  '01.01.2013',	8),
           ('ОХ',		1069,  '01.01.2013',	4)
insert into PROGRESS (SUBJECT,IDSTUDENT,PDATE, NOTE)
    values ('ЭТ',		1055,  '01.01.2013',	7),
           ('ЭТ',		1056,  '01.01.2013',	8),
           ('ЭТ',		1057,  '01.01.2013',	9),
           ('ЭТ',		1058,  '01.01.2013',	4),
           ('ЭТ',		1059,  '01.01.2013',	5)