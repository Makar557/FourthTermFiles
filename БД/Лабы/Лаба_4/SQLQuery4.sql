use master
go
create database KEV_UNIVER
    on primary
(
name = N'KEV_UNIVER_mdf',
filename = N'D:\Университет\4sem\БД\Лабы\DATABASE\KEV_UNIVER_mdf.mdf',
size = 10240Kb,
maxsize=UNLIMITED,
filegrowth=1024Kb
),
(
name = N'KEV_UNIVER_ndf',
filename = N'D:\Университет\4sem\БД\Лабы\DATABASE\KEV_UNIVER_ndf.ndf',
size = 10240KB,
maxsize=1Gb,
filegrowth=25%
),
filegroup G1
(
name = N'KEV_UNIVER_G1',
filename = N'D:\Университет\4sem\БД\Лабы\DATABASE\KEV_UNIVER_fgq-1.ndf',
size = 10240Kb,
maxsize=1Gb,
filegrowth=25%
),
filegroup G2
(
name = N'KEV_UNIVER_G2',
filename = N'D:\Университет\4sem\БД\Лабы\DATABASE\KEV_UNIVER_fgq-2.ndf',
size = 10240Kb,
maxsize=1Gb,
filegrowth=25%
)
log on
(
name = N'KEV_UNIVER_log',
filename=N'D:\Университет\4sem\БД\Лабы\DATABASE\KEV_UNIVER_log.ldf',
size=10240Kb,
maxsize=2048Gb,
filegrowth=10%
)
