...
// CGG_1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCGG1App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CCGG1App::OnAppAbout)
...
CCGG1App::CCGG1App() noexcept
{
	...
	SetAppID(_T("CGG1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CCGG1App

CCGG1App theApp;


// Инициализация CCGG1App

BOOL CCGG1App::InitInstance()
{
...
// Обработчики сообщений CCGG1App
...
void CCGG1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CCGG1App

void CCGG1App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CCGG1App::LoadCustomState()
{
}

void CCGG1App::SaveCustomState()
{
}
