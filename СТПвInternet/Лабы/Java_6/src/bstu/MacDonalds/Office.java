...
{
    private ArrayList<bstu.MacDonalds.Consumer> queue;
    ...
    public void addConsumer(bstu.MacDonalds.Consumer consumer)
    {
    ...
    public bstu.MacDonalds.Consumer popConsumerFromEnd()
    {
    ...
    public String toString()
    {
        ...
        for (bstu.MacDonalds.Consumer consumer : queue)
        {
